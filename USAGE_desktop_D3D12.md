...
Capture Looping File | GFXRECON_CAPTURE_LOOP | BOOL | Enable capture of a file for looping replay. Trimmed capture must also be enabled. DX12 only. Default is `false`.
